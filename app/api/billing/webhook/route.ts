          ...
          body: JSON.stringify({
            ...
            html: `
              <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #1a1a1a;">
                ...
                <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://nekaid.co.uk'}${accountType === 'agency' ? '/agency' : '/company'}" style="display: inline-block; background: #16307f; color: #fff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-size: 15px; font-weight: 600;">Go to dashboard</a>
