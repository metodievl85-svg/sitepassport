export default function TermsPage() {
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px', lineHeight: 1.7 }}>
      ...
      <h2>6. Verification disclaimer</h2>
      <p>
      ...
      <h2>7. QR codes and public scan links</h2>
      <p>
      ...
      <h2>8. Site attendance and GPS</h2>
      <p>
      ...
      <h2>14. Account deletion and suspension</h2>
      <p>
