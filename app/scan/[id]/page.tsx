        ...
        >
          <div style={{ display: 'grid', gap: 24 }}>
            <div className="profile-photo-card">
              ...
              >
                Check that the visible card image matches the operative details and
                card number shown on this page.
              </p>
            </div>
            ...
            <div className="card">
              ...
              >
                Use the checks below to confirm the operative details before saving to
